...
function pageResult() {
  ...
  return `<main class="page"><div class="grid2"><div class="panel">
    <div class="steps"><b>You finished intake.</b> This is the consumer result. Next is step 3, the specialist inbox for ${rec.id}. Use Step 3: Specialist accept or the 3 Accept button in the top bar.</div>
